...
export const InsertProductSchema = z.object({
  name: z
    ...
    .max(255, "Name should be atmost 255 characters long"),
  slug: z
    .string()
    .min(3, "Slug must be atleast 3 characters long")
    .max(255, "Slug must be atmost 255 characters long"),
  category: z
    .string()
    .min(3, "Category must be atleast 3 characters long")
    .max(255, "Category must be atmost 255 characters long"),
  brand: z
    .string()
    .min(3, "Brand must be atleast 3 characters long")
    .max(255, "Brand must be atmost 255 characters long"),
  description: z
    .string()
    .min(3, "Description must be atleast 3 characters long")
    .max(255, "Description must be atmost 255 characters long"),
